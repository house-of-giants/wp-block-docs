  ...
  const faqSchema = generateFAQSchema([
    {
      ...
      answer:
        "WordPress Gutenberg blocks are the fundamental units of content in WordPress's block editor. Each block represents a different type of content like paragraphs, headings, images, or complex layouts, and generates specific HTML markup.",
    },
    {
      question: "How do I learn WordPress block markup syntax?",
      answer:
        "Our comprehensive documentation covers all WordPress block markup syntax with interactive examples, live validation, and copy-paste code snippets. Start with our basic block examples and progress to advanced patterns.",
    },
    {
      question: "What's the difference between WordPress blocks and HTML?",
      answer:
        "WordPress blocks use HTML with special WordPress comments that define block types and attributes. For example: <!-- wp:paragraph --> surrounds regular HTML paragraph tags to create a WordPress paragraph block.",
    },
    {
      question: "Can I validate my WordPress block markup?",
      answer:
        "Yes! Our block validator tool provides real-time validation of WordPress block markup, checking for syntax errors, accessibility issues, and best practices with custom syntax highlighting.",
    },
  ]);
      ...
      <div className="space-y-16">
        ...
        <div className="text-center space-y-8">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            Demystify the often obscure and under-documented block comment
            syntax. Your complete guide to understanding the HTML markup of
            WordPress core blocks used in block themes and patterns.
          </p>
